    ...
    >
      ...
      <div className="relative flex items-center gap-2">
        ...
        <button 
          ...
          className="ml-4 bg-primary-foreground/20 text-primary-foreground p-2 px-4 rounded-xl text-sm font-semibold flex items-center gap-2 hover:bg-primary-foreground/30 transition-colors"
        >
